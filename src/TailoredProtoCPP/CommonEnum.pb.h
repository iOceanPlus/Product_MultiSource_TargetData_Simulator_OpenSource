...
#ifndef PROTOBUF_INCLUDED_CommonEnum_2eproto
#define PROTOBUF_INCLUDED_CommonEnum_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_CommonEnum_2eproto 
...
const PB_Enum_Software PB_Enum_Software_MAX = EV_Software_Any;
...
template <> struct is_proto_enum< ::PB_Enum_Aggregated_AIS_Ship_Type> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::PB_Enum_Software> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PB_Enum_Software>() {
  return ::PB_Enum_Software_descriptor();
}
template <> struct is_proto_enum< ::PB_Enum_Target_ThreatLevel> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PB_Enum_Target_ThreatLevel>() {
  return ::PB_Enum_Target_ThreatLevel_descriptor();
}
template <> struct is_proto_enum< ::PB_Enum_Target_XGSCustomizedThreatLevel> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::PB_Enum_Region_Shape> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_CommonEnum_2eproto
